package com.dorigao.catalogo;

import com.dorigao.catalogo.controller.CatalogoController.CriarProdutoRequest;
...
class CatalogoApplicationTests {
    ...
    void shouldReturn404ForInvalidId() throws Exception {
        mockMvc.perform(get("/api/catalogo/00000000-0000-0000-0000-000000000000"))
